  ...
  return (
    <section className="py-20 bg-secondary border-t border-border">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-4">Licenses & <span className="text-primary">Certifications</span></h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          {certs.map((cert, index) => (
            <motion.div
              ...
              className="bg-card rounded-2xl p-8 shadow-sm hover:shadow-xl hover:shadow-primary/10 hover:border-primary/50 border border-border transition-all duration-300 group"
            >
              ...
              <h3 className="text-xl font-bold text-foreground mb-2 leading-snug">{cert.title}</h3>
